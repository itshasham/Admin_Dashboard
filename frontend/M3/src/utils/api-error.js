const FRIENDLY_FIELD_LABELS = {
  ...
  "seo.secondaryKeywords": "Secondary keywords",
  "workflow.status": "Workflow status",
  "workflow.scheduledFor": "Scheduled date",
  "workflow.publishedAt": "Published date",
  "automation.targetKeyword": "Target keyword",
